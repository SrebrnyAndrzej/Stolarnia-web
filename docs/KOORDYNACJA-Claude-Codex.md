...
|---|---|---|
| (etap 3) | Szuflada ukryta za frontem: `dodajUkrytaSzuflade`, `inner_drawer` + `coupler` LEGRABOX | Odczyt LEGRABOX s.16–18: komora 104/109, oś min 38, nad osią 66/71, ZI7.0M07, wykluczenie TIP-ON. Wiercenie Ø25 we froncie: znaczenie wymiarów min 17 / 59 / x / x+46 |
