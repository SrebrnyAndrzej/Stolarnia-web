...
export const api = {
  ...
  polecenieKonstrukcji: (id: string, mid: string, polecenie: { typ: "zamienDrzwiNaSzuflady" | "dodajSzufladyZaDrzwiami"; liczba: number; wysokoscMM?: number; poleId?: string } | { typ: "dodajUkrytaSzuflade"; sprzezona: boolean; poleId?: string } | { typ: "podzielWnetrze"; kierunek: "pion" | "poziom"; liczba: number; strefaId?: string; rozmiaryMM?: number[] }) =>
